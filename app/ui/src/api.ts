...
export interface ActiveProjectRow {
  ...
  total_cost: number; total_tokens: number; hit_rate: number; last_model: string;
}
export interface FloatData {
  today_cost: number; today_tokens: number;
  project_cost: number; project_tokens: number; project_hit_rate: number; project_id: number | null; project_name: string; model: string;
